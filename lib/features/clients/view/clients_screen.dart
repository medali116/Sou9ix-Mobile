...
import 'package:sou9ix/features/clients/service/client_export_service.dart';
import 'package:sou9ix/features/clients/service/client_payment_receipt_service.dart';
  ...
  Future<void> _confirmDelete(Client c) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('« ${c.nom} » sera définitivement supprimé du karné.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
            child: const Text('Annuler'),
    ...
    if (confirmed == true) {
      ref.read(clientsProvider.notifier).removeClient(c.id);
    }
  }

...
import 'package:sou9ix/caissier/routing/app_router.dart';
...
void main() async {
  ...
  runApp(
    ProviderScope(
      ...
      child: const Sou9ixCaissierApp(),
    ),
  );
}

class Sou9ixCaissierApp extends StatelessWidget {
  const Sou9ixCaissierApp({super.key});

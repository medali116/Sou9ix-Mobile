...
import 'package:sou9ix/shared/features/alerts/viewmodel/settings_provider.dart';
                  ...
                  KeyedSubtree(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...lowStock.map((p) => _ProductAlertTile(product: p, isAdmin: isAdmin)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 22),
                  ...
                  KeyedSubtree(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        ...expiringSoon.map((p) => _ProductAlertTile(product: p, isAdmin: isAdmin)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 22),
                  ...
                  KeyedSubtree(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        ...expired.map((p) => _ProductAlertTile(product: p, isAdmin: isAdmin)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 22),
                  ...
                  KeyedSubtree(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        ...lossProducts.map((p) => _LossProductTile(product: p, isAdmin: isAdmin)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 22),
                  ...
                  KeyedSubtree(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        ...staleProducts.map((p) => _StaleProductTile(product: p, isAdmin: isAdmin)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 22),
...
class _ProductAlertTile extends StatelessWidget {
  ...
  final bool isAdmin;
  const _ProductAlertTile({required this.product, required this.isAdmin});
...
class _LossProductTile extends StatelessWidget {
  final Product product;
  final bool isAdmin;
  const _LossProductTile({required this.product, required this.isAdmin});
...
class _StaleProductTile extends StatelessWidget {
  final Product product;
  final bool isAdmin;
  const _StaleProductTile({required this.product, required this.isAdmin});

...
import '../pos/weight_entry_sheet.dart';
...
class _EditSaleScreenState extends ConsumerState<EditSaleScreen> {
  ...
  double get _total => _lignes.fold(0, (sum, l) => sum + l.sousTotal);
            ...
            ...List.generate(_lignes.length, (index) {
              ...
              return Padding(
                ...
                child: _EditableLineRow(
                  item: item,
                  onIncrement: () => _updateQuantite(index, item.quantite + 1),
                  onDecrement: () => _updateQuantite(index, item.quantite - 1),
      ...
      child: Row(
        children: [
          ...
          if (product.venduAuPoids)
            ...
            Row(
              children: [
                _smallIconBtn(icon: Icons.remove_rounded, onTap: onDecrement),
                SizedBox(
                  width: 22,
                  child: Text(
                ...
                _smallIconBtn(icon: Icons.add_rounded, onTap: onIncrement),
              ],
            ),
